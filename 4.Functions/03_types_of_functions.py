...
tulisan = open("4.Function_content.txt", "w") #Perintah membuka file content.txt dengan type writeable (menulis file, tidak hanya membacanya saja) dan di assign ke varibel tulisan.
